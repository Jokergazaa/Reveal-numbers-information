...
print(Fore.RED + "Warning: [!] Legal Disclaimer: It is illegal to use Phone-Num-Info to attack targets without prior mutual consent. It is the end user's responsibility to comply with all applicable state laws. The developers take no responsibility and assume no liability for any misuse or damage caused by this tool🇵🇸🇵🇸")
t.sleep(5)
os.system("clear")
def loop():
    os.system("clear")
    ...
    print(Fore.RED + " Version 9.0".center(60))
    print(Fore.YELLOW + "[+] " + Fore.GREEN + "Tool Name:phone-num-info\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Author:AHM7D Sy.(Palestinian hackers🇵🇸)\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Version:9.0🇵🇸\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Ay:Palestinian🇵🇸 hackers\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "facebook:https://www.facebook.com/JOGeeR.plstaeeen/\n" + Fore.YELLOW + "[+] " + Fore.GREEN + "Follow me on Github:https://github.com/Jokergazaa")
    print(Fore.RED + ">>>>>>>>>>>>>>>>>>>>>>>>>>>>" + Fore.CYAN + "Choose a valid option" + Fore.RED + "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<")
    print(Fore.BLUE + """
[1] Get the figure information🇵🇸
[2] Get your ISP's phone number🇵🇸
[3] Extracting phone numbers and saving them in a document🇵🇸
[4] PhoneNumber Validator 🇵🇸
[5] Update the tool my love 🇵🇸
...
#           z = str(extracting)
        ...
        t. sleep(3)
        os.system ("xdg-open https://t.me/jokerplstaeen")
    elif option == 7:
